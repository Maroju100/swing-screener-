...
>
> Live impact to date is nil — DAILY_STOP has never fired in production since it
> deployed 2026-09-06 — so the harm is prospective, not realised. **Disabling it
> needs an explicit decision; it has not been changed.**
